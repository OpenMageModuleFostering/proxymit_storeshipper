...
class Proxymit_StoreShipper_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    public function getStoresAction() {
        ...
        <div id="stores" style="padding:0px; max-height: 300px; overflow: auto; border: 0px;" class="stores fieldset">
            <h2 class="legend"><?php echo $this->__("Stores list") ?></h2>
            <div id="search-result">
                <?php if(count($stores)>0) {?>
                    <table class="data-table">
                        <tr>
                            <th><?php echo $this->__("Store Name") ?></th>
                            <?php if (isset($params['search']) && $params['search']!="2"){?><th><?php echo $this->__("Address") ?></th><?php }?>
                ...
                <?php }else{
                    echo $this->__("No available stores");
